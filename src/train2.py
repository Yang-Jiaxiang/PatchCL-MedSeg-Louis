...
if __name__=="__main__":
    ...
    cross_entropy_loss = CE_loss(num_classes=num_classes, image_size=img_size)
    ...
    for c_epochs in range(100): #100 epochs supervised pre training
        ...
        for batch in labelled_dataloader:
            ...
            with torch.no_grad():
                ...
                patch_list = _get_patches(imgs, p_masks,classes=num_classes,background=True,img_size=img_size,patch_size=patch_size)
