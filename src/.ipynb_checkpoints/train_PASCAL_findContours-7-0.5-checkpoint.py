...
# %%
model = torch.load(f"{base_path}/output/7-0.5/SSL-Resnet18_Image-224_patchSize-7_ContrastieWeights-0.5_s_39.pth")
teacher_model = torch.load(f"{base_path}/output/7-0.5/SSL-Resnet18_Image-224_patchSize-7_ContrastieWeights-0.5_t_39.pth")
...
for c_epochs in range(40,200): #200 epochs supervised SSL
    step=0
    min_loss = math.inf
    epoch_t_loss=0
    print('Epoch ',c_epochs)
