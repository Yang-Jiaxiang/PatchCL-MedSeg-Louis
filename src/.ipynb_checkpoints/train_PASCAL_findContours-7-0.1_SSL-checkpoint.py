...
# %%
model = torch.load(f"{base_path}/output/7-0.1/best_contrast-Resnet18_Image-224_patchSize-7_ContrastieWeights-0.1_s_epoch19_SSL.pth")
teacher_model = torch.load(f"{base_path}/output/7-0.1/best_contrast-Resnet18_Image-224_patchSize-7_ContrastieWeights-0.1_t_epoch19_SSL.pth")
...
for c_epochs in range(21,200): #200 epochs supervised SSL
    step=0
    min_loss = math.inf
    epoch_t_loss=0
    print('Epoch ',c_epochs)
